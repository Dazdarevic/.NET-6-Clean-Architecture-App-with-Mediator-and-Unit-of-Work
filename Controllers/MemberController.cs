...
namespace Napredne_baze_podataka_API.Controllers
{
    ...
    public class MemberController : ControllerBase
    {
        ...
        [Authorize]
        public async Task<IActionResult> SortTrainers(string sortByField)
        {
            var query = new SortTrainersQuery { SortByField = sortByField };
        ...
        //[Authorize]
        public async Task<IActionResult> GetPaginatedTrainers(int page, int pageSize)
        {
            var query = new GetPaginatedTrainersQuery(page, pageSize);
